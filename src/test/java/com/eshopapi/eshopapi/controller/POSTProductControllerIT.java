  ...
  @Autowired private MockMvc mockMvc;
    ...
    * then calls GET "products" by ID to verify the product was added*/
    ...
    public void testAddProduct() throws Exception {
      ...
      final String expectedResponse = String.format("{\"productId\":7,\"name\":\"Cheap and cheerful lager beer\",\"price\":3.99,\"addedAt\":\"%s\",\"labels\":[\"drink\"]}",
...
//  Now try and add the same product again
    final String expectedErrorResponse = "{\"status\":400,\"error\":\"Product name already exists\",\"message\":\"A product with the same name already exists\",\"path\":\"uri=/products\"}";
    mockMvc
            .perform(
                    MockMvcRequestBuilders.post("/products")
                            .contentType(MediaType.APPLICATION_JSON)
  ...
  public void testAddProductNameEmpty() throws Exception {
    ...
    final String expectedResponse = "{\"status\":400,\"error\":\"Validation Error\",\"message\":\"name: must not be empty\",\"path\":\"uri=/products\"}";
    mockMvc
            .perform(
                    MockMvcRequestBuilders.post("/products")
                            .contentType(MediaType.APPLICATION_JSON)
  ...
  public void testAddProductNameNull() throws Exception {
    ...
    public void testAddProductNameInvalid() throws Exception {
      ...
      final String expectedResponse = "{\"status\":400,\"error\":\"Validation Error\",\"message\":\"name: Product name must not exceed 200 characters\",\"path\":\"uri=/products\"}";
    ...
    public void testAddProductLabelsInvalid() throws Exception {
      ...
      final String expectedResponse = "{\"status\":400,\"error\":\"Label not valid\",\"message\":\"Label is not valid\",\"path\":\"uri=/products\"}";
  ...
  public void testAddProductPriceInvalid() throws Exception {
    ...
    final String expectedResponse = "{\"status\":400,\"error\":\"Parse Error\",\"message\":\"JSON parse error: Cannot deserialize value of type `java.math.BigDecimal` from String \\\"abc\\\": not a valid representation\",\"path\":\"uri=/products\"}";
    mockMvc
            .perform(
                    MockMvcRequestBuilders.post("/products")
                            .contentType(MediaType.APPLICATION_JSON)
  ...
  public void testAddProductPriceEmpty() throws Exception {
    ...
    final String expectedResponse = "{\"status\":400,\"error\":\"Validation Error\",\"message\":\"price: must not be null\",\"path\":\"uri=/products\"}";
    mockMvc
            .perform(
                    MockMvcRequestBuilders.post("/products")
                            .contentType(MediaType.APPLICATION_JSON)
  ...
  public void testAddProductPriceTooPrecise() throws Exception {
    ...
    final String expectedResponse = "{\"status\":400,\"error\":\"Validation Error\",\"message\":\"price: numeric value out of bounds (<10 digits>.<2 digits> expected)\",\"path\":\"uri=/products\"}";
    mockMvc
            .perform(
                    MockMvcRequestBuilders.post("/products")
                            .contentType(MediaType.APPLICATION_JSON)
